...
@section('head')
    <title>Features - {{ Settings::get('site_name') }}</title>
@endsection
	                            ...
	                            <div class="uk-button-dropdown" data-uk-dropdown>
	                                ...
	                                <div class="uk-dropdown uk-dropdown-small">
	                                    <ul class="uk-nav uk-nav-dropdown">
	                                        <li><a href="bikes/types/{{ $feature->id }}">Edit</a></li>
	                                        <li><a href="bikes/types/clone/{{ $feature->id }}">Clone</a></li>
	                                        <li><a id="{{ $feature->id }}" onclick="deleteObject(this)">Delete</a></li>
	                                    </ul>
	                                </div>
	                            </div>
	                        </td>
