...
(function(UI) {
    ...
    UI.modal.confirm = function(content, onconfirm, options, viewOptions) {

        onconfirm = UI.$.isFunction(onconfirm) ? onconfirm : function(){};

        var modal = UI.modal.dialog(([
            '<div class="uk-margin uk-modal-content">'+String(content)+'</div>',
            '<div class="uk-modal-footer uk-text-right"><button class="uk-button uk-button-primary js-modal-confirm">'+String(viewOptions.ok || 'Ok')+'</button> <button class="uk-button uk-modal-close">'+String(viewOptions.cancel || 'Cancelar')+'</button></div>'
    ...
    UI.modal.prompt = function(text, value, onsubmit, options, viewOptions) {

        onsubmit = UI.$.isFunction(onsubmit) ? onsubmit : function(value){};

        var modal = UI.modal.dialog(([
            text ? '<div class="uk-modal-content uk-form">'+String(text)+'</div>':'',
            '<div class="uk-margin-small-top uk-modal-content uk-form"><p><textarea class="uk-width-1-1" rows='+String(viewOptions.row || 5)+'></textarea></p></div>',
            '<div class="uk-modal-footer uk-text-right"><button class="uk-button uk-button-primary js-modal-ok">'+String(viewOptions.ok || 'Enviar')+'</button> <button class="uk-button uk-modal-close">'+String(viewOptions.cancel || 'Cancelar')+'</button></div>'
        ]).join(""), UI.$.extend({bgclose:false, keyboard:false}, options)),
